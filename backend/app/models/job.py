...
class Job(Base):
    ...
    predicted_priority_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    predicted_close_risk_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    predicted_response_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    prediction_confidence: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    prediction_evidence: Mapped[dict | None] = mapped_column(JSON, nullable=True)
