...
from app.api.routes import ai, autofill, health, jobs, market, packets, prediction, profile, resume, tracker
...
app = FastAPI(
    ...
    version="0.11.0",
    description="Stage 11 prediction and improvements for a human-in-the-loop job search assistant.",
    lifespan=lifespan,
)
