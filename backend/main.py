...
from app.api.routes import autofill, health, jobs, market, packets, profile, resume, tracker
...
app = FastAPI(
    ...
    version="0.2.0",
    description="Stage 2 foundation for a human-in-the-loop job search assistant.",
    lifespan=lifespan,
)
